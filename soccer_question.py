...
# in order to deal with dashes in the data file, I read in the text first for easy editing
f = open('soccer.dat')
text = ''
count = 0
for line in f:
...
soccer = pd.read_csv(StringIO(text),skipfooter=1,delimiter=r"\s+",engine='python').dropna()
